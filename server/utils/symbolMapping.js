...
export const SYMBOL_MAP = {
  ...
  USDJPY: { oanda: 'USD_JPY', yahoo: 'USDJPY=X', tradingview: 'OANDA:USDJPY', assetClass: 'Forex', cotKey: COT_MAP['USDJPY'], invertCot: true },
  ...
  USDCAD: { oanda: 'USD_CAD', yahoo: 'USDCAD=X', tradingview: 'OANDA:USDCAD', assetClass: 'Forex', cotKey: COT_MAP['USDCAD'], invertCot: true },
  USDCHF: { oanda: 'USD_CHF', yahoo: 'USDCHF=X', tradingview: 'OANDA:USDCHF', assetClass: 'Forex', cotKey: COT_MAP['USDCHF'], invertCot: true },
  EURGBP: { oanda: 'EUR_GBP', yahoo: 'EURGBP=X', tradingview: 'OANDA:EURGBP', assetClass: 'Forex', cotKey: COT_MAP['EURGBP'] },
  EURJPY: { oanda: 'EUR_JPY', yahoo: 'EURJPY=X', tradingview: 'OANDA:EURJPY', assetClass: 'Forex', cotKey: 'EURJPY' },
  GBPJPY: { oanda: 'GBP_JPY', yahoo: 'GBPJPY=X', tradingview: 'OANDA:GBPJPY', assetClass: 'Forex', cotKey: 'GBPJPY' },
  CHFJPY: { oanda: 'CHF_JPY', yahoo: 'CHFJPY=X', tradingview: 'OANDA:CHFJPY', assetClass: 'Forex', cotKey: 'CHFJPY' },
  ...
  USB02YUSD: { oanda: 'USB02Y_USD', yahoo: 'ZT=F', tradingview: 'OANDA:USB02YUSD', assetClass: 'Interest Rates', cotKey: COT_MAP['USB02YUSD'] },
